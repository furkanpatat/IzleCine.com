        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Bu bir öğrenci projesidir - basit ve şeffaf bilgiler
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Hesap Bilgileri</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Kullanım Verileri</h3>
                  <p className="text-gray-300">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Çerezler</h3>
                  <p className="text-gray-300">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Şifreleme</h4>
                  <p className="text-gray-300 text-sm">
                    Hassas veriler şifrelenerek saklanır
                  </p>
                </div>
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Güvenli Bağlantı</h4>
                  <p className="text-gray-300 text-sm">
                    HTTPS protokolü kullanılır
                  </p>
                </div>
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Veri Saklama</h4>
                  <p className="text-gray-300 text-sm">
                    Veriler güvenli sunucularda saklanır
                  </p>
                </div>
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Erişim Kontrolü</h4>
                  <p className="text-gray-300 text-sm">
